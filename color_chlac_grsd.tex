...
\begin{abstract}
The greatest bottleneck momentarily in the area of mobile manipulation is robust perception. % bottleneck already suggests that it should be more efficient
In this paper contribute to the solving of this problem of efficiency and accuracy
...
rates higher than 90\% of 64 objects.
\end{abstract}
...
Though these is a trade-off between these two abilities, it will dramatically improve both of them 
...
Caputo and Dorko~\cite{caputo2002} learned respective kernels for shape and color representations and combined them for recongnizing object,
