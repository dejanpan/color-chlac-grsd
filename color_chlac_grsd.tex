...
the same value twice over symmetric pairs of ${\bm a}$. 
...
13 different vectors given by (\ref{eq:1st}) together which reduces the dimensionality of the 
descriptor down to 117 (6+36+12 for non-binarized data plus 6+36+21 for binarized data). 
