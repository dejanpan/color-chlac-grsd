...
feature descriptor that captures both the geometrcial and visual appearance
properties of the objects.
This descriptor is the composition of our previously presented Global Radius-based Surface Descriptor
...
\todo{find other way to cite ~\cite{stueckler10combining}}.
...
selection (e.g. horizontal supporting structures) and spatially seperable object
...
\subsection{How}
Since the focus of the paper is on three parts, i.e. i)GRSDColor-CHLAC descriptor
